...
// global variables
float _TARGET_NEU = (_TARGET_HIGH + _TARGET_LOW)/ 2;
...
void loop() {
  ...
  else if (dist_raw == _TARGET_NEU) myservo.writeMicroseconds(_DUTY_NEU);
  else myservo.writeMicroseconds((dist_ema - 180.0) * 105.5);
